...
$(function(){
	$('[data-toggle="popover4"]').popover({
		...
		content: function() {
			...
			console.log(id+title+summary+image+count+"asdlajsdlkjasdlkajd");
			var value = "";
			value += "<a href='javascript:snsGo4(1, "+id+", \""+title+"\", \""+summary+"\");'><img src='resources/images/snsIcn/sns_naver.png' style='width:30px;' alt='네이버'></a>&nbsp;&nbsp;";
			...
			value += "<a href='javascript:snsGo4(3, "+id+", \""+title+"\", \""+summary+"\");'><img src='resources/images/snsIcn/sns_face.png' style='width:30px' alt='페이스북'></a>&nbsp;&nbsp;";
			value += "<a href='javascript:snsGo4(4, "+id+", \""+title+"\", \""+summary+"\");'><img src='resources/images/snsIcn/sns_tw.png' style='width:30px' alt='트위터'></a><br>";
			value += "<a href='javascript:CopyUrlToClipboard4("+id+");' class='urlcopy'>URL 복사</a>";
			return value;
		}
	});
});
...
$(document).on('click', function (e) {
  $('[data-toggle="popover4"],[data-original-title]').each(function () {
...
//url 복사
function CopyUrlToClipboard4(num) {
	//window.document.location.href -> 현재 url정보 얻는 방법
	var obShareUrl = "localhost:9392/runningdog/dboardView.do?dNum=" + num + "&pageNo=1";
...
function snsGo4(e, id, title, content) {
	var url = "http://localhost:9392/runningdog/dboardView.do?dNum=" + id + "&pageNo=1";
...
Kakao.Link.createDefaultButton({
  ...
  content: {
    title: title,
    description: summary,
    imageUrl: 'http://localhost:9392/runningdog/resources/dboard/dboardImage/'+encodeURIComponent(image),
    link: {
      mobileWebUrl: "http://localhost:9392/runningdog/dboardView.do?dNum=" + id + "&pageNo=1",
      webUrl: "http://localhost:9392/runningdog/dboardView.do?dNum=" + id + "&pageNo=1"
    }
  },
  social: {
    commentCount: count

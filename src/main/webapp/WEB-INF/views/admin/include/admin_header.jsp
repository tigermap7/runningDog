...
<div id="header">
    <h1 onclick="location='/runningdog/'" title="지금 달려갈 개"><img src="/runningdog/resources/admin/images/common/logo.png" alt="지금 달려갈 개"></h1>
    <!-- gnb -->
    <ul class="gnb">
        <li>
            ...
            <div id="collapse1" class="collapse show" data-parent="#accordion">
                <a href="/WEB-INF/views/admin/member/allMember.jsp">전체회원 리스트</a>
                <a href="/WEB-INF/views/admin/member/leadeMember.jsp">탈퇴회원 리스트</a>
            </div>
        </li>
        <li>
            ...
            <div id="collapse2" class="collapse show" data-parent="#accordion">
                ...
                <a href="/WEB-INF/views/admin/userBoard/sponsorList.jsp">후원하기 관리</a>
                <a href="/WEB-INF/views/admin/userBoard/noticeList.jsp">공지사항 관리</a>
            </div>
        </li>
        <li>
        ...
        <li>
            ...
            <div id="collapse4" class="collapse show" data-parent="#accordion">
                ...
                <a href="/WEB-INF/views/admin/etc/etcView.jsp">사용자약관 관리</a>
                <a href="/WEB-INF/views/admin/etc/adminInfo.jsp">관리자 정보수정</a>
            </div>
        </li>
    </ul>
</div>
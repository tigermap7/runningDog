                ...
                <table class="list listTwo">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="userId">taeung103@naver.com</td>
                            <td class="userName">멍무이</td>
                            <td class="gender">#1971345</td>
                            <td class="phone">010-3387-7583</td>
                            <td class="joinDate">2020.09.01</td>
                            <td class="lastAccessDate">2020.09.01</td>
                            <td class="loginType"><i class="xi-kakaotalk"></i></td>
                        </tr>
                        <tr>
                            <td class="checkBox"><input type="checkbox" name="leaveChk" id="leaveChk" value=""></td>
                        ...
                        <tr>
                            ...
                            <td class="joinDate">2020.09.01</td>
                            <td class="lastAccessDate">2020.09.01</td>
                            <td class="loginType"><i class="xi-facebook-official"></i></td>
                        </tr>
                        <tr>
                            <td class="checkBox"><input type="checkbox" name="leaveChk" id="leaveChk" value=""></td>
                        ...
                        <tr>
                            ...
                            <td class="joinDate">2020.09.01</td>
                            <td class="lastAccessDate">2020.09.01</td>
                            <td class="loginType"><i class="xi-naver-square"></i></td>
                        </tr>
                        <tr>
                            <td class="checkBox"><input type="checkbox" name="leaveChk" id="leaveChk" value=""></td>
